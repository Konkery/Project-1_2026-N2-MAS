...
- **Файл эталонного шаблона**: `ШАБЛОН-спецификация work spec rev.04 v03 #2026.xlsx`
...
2. `NUM COLUMN` — порядковый номер столбца (Work_1: 1..30, Work_2: 1..18).
3. `СOLUMNS NAME` — системное английское имя столбца в смарт-таблице (48 записей в пределах схемы).
...
| 26  | `COST PRICE VAT $PURCHASE`| float | [1, 10000000] |  ✅  |    🔒 **ДА**    | **Себестоимость партии закупки С НДС** (`25 + 21 * 24`, Коммерческая тайна) |
